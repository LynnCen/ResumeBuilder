...
**[00-概念速览-是什么为什么怎么用](00-概念速览-是什么为什么怎么用.md)**

- SSR、水合、前后端同构、生命周期缓存 一句话说明
- SSR 解决什么问题、整体请求到水合的流程
- 水合为什么重要、为什么会失败
- 98% BUG 来源：四类常见问题与对应原则
- 生命周期缓存是什么、怎么用（避免数据请求两次、保证一致）
- 使用 SSR 的好处与代价
...
```
1. 概念速览（00）- 是什么、为什么、怎么用、常见坑
   ↓
2. 前后端同构快速入门（01）
   ↓ 了解 SSR 基础概念与 98% BUG 来源
3. SSR 接入文档
   ↓ 掌握实践接入流程
4. SSR 场景下接口数据请求及水合机制
   ↓ 理解核心原理
5. 根据需求选择专题深入
   ├─ 鉴权场景 → 鉴权系列文档
   └─ AB 实验 → AB 实验系列文档
...
1. 阅读 [概念速览](00-概念速览-是什么为什么怎么用.md)（可选，建议先读）与 [前后端同构快速入门](01-基础入门-前后端同构快速入门.md)
2. 了解常见陷阱：
