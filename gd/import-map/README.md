...
**[00-概念速览-是什么为什么怎么用.md](00-概念速览-是什么为什么怎么用.md)**

- Import Map、WPM 一句话说明
- 解决什么问题、如何与构建配合（external / 不打包 / 运行时从 CDN 加载）
- 常见疑问：还需要打包该包吗？如何知道引用该包？
- 使用 Import Map + external 的好处总结

**适合人群**：
- 🎯 第一次接触 Import Map
- 🎯 想快速理解「是什么、为什么、怎么用」
- 🎯 对「打包 vs Import Map」有疑问
...
import-map/
├── README.md                                      # 本文档
├── 00-概念速览-是什么为什么怎么用.md              # 概念速览（建议先读）
...
```
1. 概念速览（00）或 基础概念（01）- 了解原理
   ↓
2. 浏览器兼容性处理（04）- 立即可用
   ↓
3. 根据项目类型选择工具文档（02、03）
```
